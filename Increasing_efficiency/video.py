...
result = cv2.VideoWriter("object_tracking_with_custom_labels.avi",
    ...
    if success:
        ...
        #extract prediction results
            ...
            for box, cls, track_id in zip(boxes, clss, track_ids):
               custom_label = "Wasp"
               annotator.box_label(box, color=colors(int(cls), True), label=custom_label)
