...
video_path = r"C:\Users\komal\Downloads\Machine_learning\Videos\MVI_1842.MOV"
...
def mark_frame(frame_index):
    marked_frames.append(frame_index)
    print("Marked frame:", frame_index)
...
print('Marked Frames: {}'.format(len(marked_frames)))
print('Marked Frames List:', marked_frames)
...
while True:
    ...
    if frame_count in n_values:
       marked_frames.append(frame_count)
